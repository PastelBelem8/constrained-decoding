...
def parse_arguments() -> dict:
    ...
    #
    # Example use: python -m run_half_experiment --config ./configs/generate-pythia70m.yml --model_name EleutherAI/pythia-70m
...
if __name__ == "__main__":
    ...
    for decoder_name, decoder_config in decoding_configs:
        ...
        start = time.time()
        results = generate(prefixes=data["prefix"].values, model=model, tokenizer=tokenizer, **decoder_config)
        end = time.time()
